...
from SemanticNetworkCombiner import SemanticNetworkCombiner
...
class Agent:
    ...
    def Solve(self, problem, timeout=10, guess=True, catch_errors=False):
