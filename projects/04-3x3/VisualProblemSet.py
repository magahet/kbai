...
class VisualProblemSet:
    ...
    def addProblem(self, set, problem):
        ...
        if os.path.isfile(fullpath + "7.png"):
            newProblem.getFigures()["7"]=VisualRavensFigure("6",fullpath + "7.png")
        if os.path.isfile(fullpath + "8.png"):
            newProblem.getFigures()["8"]=VisualRavensFigure("6",fullpath + "8.png")
